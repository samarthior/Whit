...
function submit(){
    var name_1=document.getElementById("NFTS1").value
    var name_2=document.getElementById("NFTS2").value
    var name_3=document.getElementById("NFTS3").value
    var name_4=document.getElementById("NFTS4").value
